...
class RegisterScreenTest {
    ...
    // When clicking the register button, navigate to the create pet screen
    @Test
    fun navigateFromRegisterToCreatePet(){
        ...
        intended(hasComponent(CreatePetActivity::class.java.name))
    }
